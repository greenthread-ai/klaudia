...
func TestDefaultRegistryLoadsAllTools(t *testing.T) {
	...
	want := []string{"Read", "Write", "Edit", "Glob", "Grep", "Bash", "TodoWrite", "TaskCreate", "TaskList", "TaskGet", "TaskUpdate", "NotebookEdit", "AskUserQuestion", "ExitPlanMode", "WebSearch", "WebFetch", "BrowserNavigate", "BrowserSnapshot"}
